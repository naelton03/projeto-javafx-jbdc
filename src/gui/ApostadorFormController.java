...
public class ApostadorFormController implements Initializable {

	private Apostador entity;
	...
	public void setApostador(Apostador entity) {
		this.entity = entity;
	}
