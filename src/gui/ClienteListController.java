...
public class ClienteListController implements Initializable, DataChangeListener {
	...
	@FXML
	private TableColumn<Cliente, String> tableColumnTelephone;
	
	@FXML
	private TableColumn<Cliente, Date> tableColumnDataDoCadastro;
	
	@FXML
	private TableColumn<Cliente, Double> tableColumnSaldoTotal;
	...
	private void initializeNodes() {
		...
		tableColumnTelephone.setCellValueFactory(new PropertyValueFactory<>("telefone"));
		tableColumnDataDoCadastro.setCellValueFactory(new PropertyValueFactory<>("dataDoCadastro"));
		Utils.formatTableColumnDate(tableColumnDataDoCadastro, "dd/MM/yyyy");
		tableColumnSaldoTotal.setCellValueFactory(new PropertyValueFactory<>("saldoTotal"));
		Utils.formatTableColumnDouble(tableColumnSaldoTotal, 2);
